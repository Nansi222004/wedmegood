...
router.post('/inventory', protectVendor, upload.array('images', 5), createInventoryItem);
router.put('/inventory/:id', protectVendor, upload.array('images', 5), updateInventoryItem);
router.delete('/inventory/:id', protectVendor, deleteInventoryItem);
